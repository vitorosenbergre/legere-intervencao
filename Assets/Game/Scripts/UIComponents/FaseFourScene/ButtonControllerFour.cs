...
public class ButtonControllerFour : MonoBehaviour
{
    ...
    IEnumerator WaitWinFaseOne()
    {
        ...
        PlayerController.faseController = "four";
    ...
    public void LoadScenePartOne()
    {
        ...
        int randomNumber = sourceImage.pickRandomNumber(99);     //pegar vogal
        int randomDecision = sourceImage.pickRandomNumber(4);   // pegar botao
        correctButton = randomDecision;

        actualAudio = sourceImage.pickStringFaseFour(randomNumber); // pegou uma das vogais
        soundSource.clip = Resources.Load<AudioClip>("Audio/Fase4/silabas/" + actualAudio); // pegou o audio 
        ...
        while (manager)
        {
            int randomNumberVogals = sourceImage.pickRandomNumber(99);
        ...
        for(int i=0; i < 3; i++)
        {
            ...
            {
                case 0:
                    firstButtonText.text = sourceImage.pickStringFaseFour(NVs[i + 1]).ToUpper();
                    break;
                case 1:
                    secondButtonText.text = sourceImage.pickStringFaseFour(NVs[i + 1]).ToUpper();
                    break;
                case 2:
                    thirdButtonText.text = sourceImage.pickStringFaseFour(NVs[i + 1]).ToUpper();
                    break;
                case 3:
                    fourthButtonText.text = sourceImage.pickStringFaseFour(NVs[i + 1]).ToUpper();
                    break;
            }
        }
