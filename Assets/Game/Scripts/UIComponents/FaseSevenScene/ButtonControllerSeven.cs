...
public class ButtonControllerSeven : MonoBehaviour
{
    ...
    IEnumerator WaitWinFaseOne()
    {
        ...
        PlayerController.faseController = "seven";
    ...
    public void LoadScenePartOne()
    {
        ...
        int randomNumber = sourceImage.pickRandomNumber(30);     //pegar vogal
        int randomDecision = sourceImage.pickRandomNumber(4);   // pegar botao
        correctButton = randomDecision;

        actualAudio = sourceImage.pickStringFaseSeven(randomNumber); // pegou uma das vogais
        soundSource.clip = Resources.Load<AudioClip>("Audio/Fase7/silabas/" + actualAudio); // pegou o audio 
        ...
        while (manager)
        {
            int randomNumberVogals = sourceImage.pickRandomNumber(30);
        ...
        for(int i=0; i < 3; i++)
        {
            ...
            {
                case 0:
                    firstButtonText.text = sourceImage.pickStringFaseSeven(NVs[i + 1]).ToUpper();
                    break;
                case 1:
                    secondButtonText.text = sourceImage.pickStringFaseSeven(NVs[i + 1]).ToUpper();
                    break;
                case 2:
                    thirdButtonText.text = sourceImage.pickStringFaseSeven(NVs[i + 1]).ToUpper();
                    break;
                case 3:
                    fourthButtonText.text = sourceImage.pickStringFaseSeven(NVs[i + 1]).ToUpper();
                    break;
            }
        }
    ...
    {
        SceneManager.LoadScene("Seven_SC");
        Time.timeScale = 1f;
    }
