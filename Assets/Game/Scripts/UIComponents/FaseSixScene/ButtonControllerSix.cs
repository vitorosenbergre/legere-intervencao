...
public class ButtonControllerSix : MonoBehaviour
{
    ...
    IEnumerator WaitWinFaseOne()
    {
        ...
        PlayerController.faseController = "six";
    ...
    public void LoadScenePartOne()
    {
        ...
        int randomNumber = sourceImage.pickRandomNumber(59);     //pegar vogal
        int randomDecision = sourceImage.pickRandomNumber(4);   // pegar botao
        correctButton = randomDecision;

        actualAudio = sourceImage.pickStringFaseSix(randomNumber); // pegou uma das vogais
        soundSource.clip = Resources.Load<AudioClip>("Audio/Fase6/silabas/" + actualAudio); // pegou o audio 
        ...
        while (manager)
        {
            int randomNumberVogals = sourceImage.pickRandomNumber(59);
        ...
        for(int i=0; i < 3; i++)
        {
            ...
            {
                case 0:
                    firstButtonText.text = sourceImage.pickStringFaseSix(NVs[i + 1]).ToUpper();
                    break;
                case 1:
                    secondButtonText.text = sourceImage.pickStringFaseSix(NVs[i + 1]).ToUpper();
                    break;
                case 2:
                    thirdButtonText.text = sourceImage.pickStringFaseSix(NVs[i + 1]).ToUpper();
                    break;
                case 3:
                    fourthButtonText.text = sourceImage.pickStringFaseSix(NVs[i + 1]).ToUpper();
                    break;
            }
        }
